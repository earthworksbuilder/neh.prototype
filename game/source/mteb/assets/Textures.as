package mteb.assets
{
	...
	public final class Textures
	{
		...
		[Embed(source="/../assets/textures/artifacts/artifact-1.png", mimeType="image/png")]
		private static const Artifact1Texture:Class;

		[Embed(source="/../assets/textures/artifacts/artifact-1-borderless.png", mimeType="image/png")]
		private static const Artifact1BorderlessTexture:Class;

		[Embed(source="/../assets/textures/artifacts/artifact-2.png", mimeType="image/png")]
		private static const Artifact2Texture:Class;

		[Embed(source="/../assets/textures/artifacts/artifact-2-borderless.png", mimeType="image/png")]
		private static const Artifact2BorderlessTexture:Class;

		[Embed(source="/../assets/textures/artifacts/artifact-3.png", mimeType="image/png")]
		private static const Artifact3Texture:Class;

		[Embed(source="/../assets/textures/artifacts/artifact-3-borderless.png", mimeType="image/png")]
		private static const Artifact3BorderlessTexture:Class;

		[Embed(source="/../assets/textures/artifacts/artifact-4.png", mimeType="image/png")]
		private static const Artifact4Texture:Class;

		[Embed(source="/../assets/textures/artifacts/artifact-4-borderless.png", mimeType="image/png")]
		private static const Artifact4BorderlessTexture:Class;

		[Embed(source="/../assets/textures/compass-1024x1024.png", mimeType="image/png")]
		private static const CompassTexture:Class;

		[Embed(source="/../assets/textures/moonmap-512x256.jpg", mimeType="image/jpeg")]
		private static const MoonTexture:Class;

		[Embed(source="/../assets/textures/starfield-2048x1024.png", mimeType="image/png")]
